...
fn = ('/Users/elinemertens/Data/Projects/NEW_Hippocampus_2022_07/Data/revision/Hipp cluster + MTS/Hipp_cluster_analysis_ephys_morph_MTS_n=41_n=7par.csv');
...
patients = readcell('/Users/elinemertens/Data/Projects/NEW_Hippocampus_2022_07/Data/revision/Hipp cluster + MTS/Hipp_group_parameter_ephys_morph_MTS_n=41.csv');
...
for i=1:numel(unpats)
    ...
    scatter(tm(locs,1),tm(locs,2), 90, c(clusternr,:), 'filled', mkrs{i})
    %ylim([-250 250]) ;
    legend('P117', 'P198', 'P209' , 'PMTS')
